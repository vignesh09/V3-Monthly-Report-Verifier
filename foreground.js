...
// console.log(document.getElementById('dyntable'))

// const html = fs.readFileSync(path.resolve(__dirname, 'tables.html'), {encoding: 'UTF-8'});

// const converted = tabletojson.convert(html);

// let converted = new Tabletojson()
// let res = converted.convert(document.getElementById('dyntable'))

$('[name=dyntable_length]').val(200);
$('[name=dataTables_length]').val(200);

// $('[name=dataTables_length]').click(function() {
//   $('[name=dataTables_length]').val(200).trigger('change');
// });
//
// $('[name=dyntable_length]').click(function() {
//   $('[name=dyntable_length]').val(200).trigger('change');
// });
